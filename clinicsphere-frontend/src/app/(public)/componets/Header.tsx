            ...
            <div className="container mx-auto px-4 flex justify-between items-center">
                ...
                <nav className="hidden lg:flex space-x-1 items-center">
                    ...
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                        <Link
                            href="/auth"
                            className="ml-3 inline-flex items-center justify-center px-5 py-3 rounded-full border border-[#0ba350] text-[#0ba350] bg-white hover:bg-[#0ba350]/10 font-semibold shadow transition-all duration-300"
                        >
                            Login
                        </Link>
                    </motion.div>
                        ...
                        <div className="w-full max-w-md">
                            ...
                            <motion.div className="mt-4" variants={itemVariants}>
                                <Link
                                    href="/auth"
                                    onClick={() => setIsOpen(false)}
                                    className="block w-full py-4 border-2 border-[#0ba350] text-[#0ba350] rounded-xl shadow text-center font-bold text-lg hover:bg-[#0ba350]/10 transition"
                                >
                                    Login
                                </Link>
                            </motion.div>
