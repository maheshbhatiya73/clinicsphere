...
import { Appointment, AppointmentResponse, getAllAppointments } from '@/app/lib/api/api';
...
export default function AdminAppointmentsPage() {
  ...
  const fetchAppointments = async () => {
    ...
    setLoading(true);
    try {
      const response: AppointmentResponse = await getAllAppointments(page, limit, undefined, token);
    ...
    <div className="container mx-auto p-6 min-h-screen">
      ...
      <div className="mb-8">
        ...
        >
          ...
          <input
            type="text"
            placeholder="Search by doctor or patient name/email..."
            value={search}
              ...
              <AnimatePresence>
                {filteredAppointments.map((appointment) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sky-900">{appointment.patientId.name}</td>
