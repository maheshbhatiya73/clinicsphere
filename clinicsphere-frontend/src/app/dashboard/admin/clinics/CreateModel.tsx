...
interface CreateModelProps {
  isOpen: boolean;
  onClose: () => void;
  onCreate: (data: ClinicFormData) => Promise<void>;
}

const CreateModel: React.FC<CreateModelProps> = ({ isOpen, onClose, onCreate }) => {
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-sky-600">Create Clinic</h2>
