...
import { CreateAdminSpecialty } from '@/app/lib/api/api';
...
export default function CreateModal({ onClose, onSuccess }: CreateModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create payload, excluding empty optional fields and converting types
      const payload: { title: string; description: string; [key: string]: string | number } = {
      ...
      await CreateAdminSpecialty(payload, token);
      ...
      >
        ...
        >
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-sky-800">Add New Specialty</h2>
